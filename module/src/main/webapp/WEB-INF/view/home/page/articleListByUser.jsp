...
<rapid:override name="description">
    <meta name="description" content="${user.userNickname}"/>
</rapid:override>
<rapid:override name="keywords">
    <meta name="keywords" content="${user.userNickname}"/>
</rapid:override>
<rapid:override name="title">
    <title>${user.userNickname}的个人首页</title>
</rapid:override>
