...
<head>
    ...
    <title>${information.siteTitle} - 登录</title>
...
<%--    <h1><a href="/" title="欢迎您光临本站！" tabindex="-1">${options.optionSiteTitle}</a></h1>--%>
    ...
    <form name="loginForm" id="loginForm"  method="post">
        ...
        <p class="forgetmenot"><label for="rememberme"><input name="rememberme" type="checkbox" id="rememberme" value="1"  /> 记住密码</label></p>
        <p class="submit">
    ...
    <p id="backtoblog"><a href="/">首页 |</a><a href="/register"> 注册</a></p>
