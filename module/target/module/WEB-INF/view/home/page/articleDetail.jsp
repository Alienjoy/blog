    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            ...
            <div class="authorbio wow fadeInUp">
                ...
                <ul class="postinfo">
                    <li></li>
                    <li><strong>版权声明：</strong>本站原创文章，由
                        <strong>
                    ...
                    <li class="reprinted"><strong>转载请注明：</strong>
                        <a href="/article/${article.articleId}"
                           ...
                           title="本文固定链接 /article/${article.articleId}">
                                ${article.articleTitle} | ${information.siteTitle}</a>
                    </li>
                </ul>
                <div class="clear"></div>
            </div>
                ...
                <div id="respond" class="comment-respond">
                    ...
                    <form id="comment_form" method="post">
                        ...
                        <div id="comment-author-info">
                            ...
                            <input type="hidden" name="commentPuserId" value="${article.articleUserId}">
                                ...
                                <div id="div-comment-${c.commentId}" class="comment-body">
                                    <div class="comment-author vcard">
                                        <img class="avatar" src="${c.commentAuthorAvatar}" alt="avatar"
                                            ...
                                            <%--评论者的名字，在回复的时候会被写入数据库，读出的时候在<c:if test="${c2.commentPid!=0}">
                                                                    <span class="at">@ ${c2.commentPname}</span>
                                                                </c:if>
                                                                会被显示出来
                                                                --%>
                                        <strong>${c.commentAuthorName} </strong>
                                        <b style="display:none" class="commentPuserId">${c.commentUserId}</b>
                                        <c:if test="${c.commentUserId==article.articleUserId}">
...
<%--                                                    <span class="floor"> &nbsp;${floor}楼 </span>--%>
                                ...
                                <ul class="children">
                                    ...
                                    <c:forEach items="${commentListReverse}" var="c2">
                                                ...
                                                <div id="div-comment-${c.commentId}" class="comment-body">
                                                    <div class="comment-author vcard">
                                                        ...
                                                        <b style="display:none"
                                                           class="commentPuserId">${c2.commentUserId}</b>

                                                        <c:if test="${c2.commentUserId==article.articleUserId}">
                                                            <i class="fa fa-black-tie" style="color: #c40000;"></i>
                                                            <span class=""
                                                                  style="margin-top: 2px!important;color: #c40000;font-size: 13px;;"><b>博主</b></span>
                                                        </c:if>
...
<rapid:override name="footer-script">
    ...
    <script type="text/javascript">
        ...
        layui.code({
            ...
            // skin: 'notepad', //如果要默认风格，不用设 定该key。
            about: false,
            title: "代码"
        });
